...
import logging
logger = logging.getLogger('o_browser_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by OBrowserWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseOBrowserWindow object.
        """
        builder = get_builder('OBrowserWindow')
        new_object = builder.get_object("o_browser_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a OBrowserWindow object with it in order to finish
        initializing the start of the new OBrowserWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.o-browser")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('o-browser')
        except ImportError:
            pass
        ...
        try:
            from o_browser import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for o-browser."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for o-browser."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the OBrowserWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the OBrowserWindow is closed."""
